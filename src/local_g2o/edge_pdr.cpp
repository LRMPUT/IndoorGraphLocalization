...
//		double averageAngle = normalize_theta(delta[2]) / 2.0;
        ...
        //		std::cout << "MY jacobianOplus[0] = " << std::endl << _jacobianOplus[0] << std::endl;
//		std::cout << "MY jacobianOplus[1] = " << std::endl << _jacobianOplus[1] << std::endl;
//		std::cout << "MY jacobianOplus[2] = " << std::endl << _jacobianOplus[2] << std::endl;
        //exit(0);
