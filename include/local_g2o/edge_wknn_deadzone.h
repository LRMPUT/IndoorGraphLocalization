 ...
 */
#ifndef G2O_EDGE_WKNN_DEADZONE
#define G2O_EDGE_WKNN_DEADZONE
...
namespace g2o {
    ...
    class G2O_TYPES_SLAM2D_API EdgeWKNNDeadzone : public BaseMultiEdge<-1, VectorX> {

    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW;

        // We need to provide the number of vertices (it is the WKNN k number + 1)
        EdgeWKNNDeadzone(int size=1);
