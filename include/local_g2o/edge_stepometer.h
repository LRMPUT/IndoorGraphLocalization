 ...
 */
#ifndef GRAPHLOCALIZATION_EDGE_STEPOMETER_H
#define GRAPHLOCALIZATION_EDGE_STEPOMETER_H
...
namespace g2o {
    ...
    class G2O_TYPES_SLAM2D_API EdgeStepometer : public BaseMultiEdge<-1, VectorX> {
    ...
    public:
        ...
        // Setting the measurement ([freq*dt])
...
#endif //GRAPHLOCALIZATION_EDGE_STEPOMETER_H
